...
function OurClients() {
  return (
    <div>
      <div className="pt-[20px] sm:pt-[25px] text-lightGray px-3 text-center">
        <span className="rounded-[11px] py-[8px] px-[14px] border border-darkGray">Our Clients</span>
        <h1 className="text-[30px] leading-[35px] sm:text-[35px] sm:leading-[40px] md:text-[40px] md:leading-[45px] lg:text-[55px] lg:leading-[60px] font-normal mt-6">
          Hear it directly from <br></br> <span className="font-bold italic">our clients</span>
        </h1>
